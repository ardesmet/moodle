...
* Rename the mesinfos/ folder to the name of your module (eg "widget").
...
all the instances of the string "mesinfos" to your module name
(eg "widget"). If you are using Linux, you can use the following command
$ find . -type f -exec sed -i 's/mesinfos/widget/g' {} \;

* Rename the file lang/en/mesinfos.php to lang/en/widget.php
where "widget" is the name of your module. Also rename block_mesinfos.php
...
and you should find that this mesinfos has been added to the list of
installed modules.
