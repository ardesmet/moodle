...
/**
 * Returns list of courses current $USER is enrolled in and can access and are visible
 *
 * - $fields is an array of field names to ADD
 *   so name the fields you really need, which will
 *   be added and uniq'd
 ...
 * @return array
 */
function enrol_get_my_courses_visible($fields = NULL, $sort = 'visible DESC,sortorder ASC', $limit = 0) {
    global $DB, $USER;
